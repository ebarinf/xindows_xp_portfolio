    ...
    return (
        ...
        <div className="absolute bottom-0 left-0 w-full flex select-none z-50 bg-[#1240b9] pb-[env(safe-area-inset-bottom)]">
            ...
            <button 
                ...
                className={`h-[30px] flex items-center justify-center gap-1 px-3 pr-4 bg-gradient-to-b from-[#3c8939] via-[#4db047] to-[#2a7326] rounded-tr-[15px] rounded-br-[15px] border-t-[1px] border-t-[#8ae87f] shadow-[inset_0_0_2px_rgba(255,255,255,0.4),3px_0_4px_rgba(0,0,0,0.3)] hover:brightness-110 active:brightness-90 transition-all z-20 ${isStartOpen ? 'brightness-90 inset-shadow-inner' : ''}`}
            >
